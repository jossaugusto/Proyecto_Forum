	...
	<div class="card shadow-sm">
		<div class="card-body">
			...
			<form method="get"
				...
				<div class="col-md-2">
					<button type="submit" name="action" value="ManageTopics"
					...
					<table class="table table-striped table-bordered">
						...
						<tbody>
							<c:forEach var="topic" items="${listTopics}">
								<tr>
									<td>${topic.id_tema}</td>
									<td>${topic.nombreUsuario} ${tema.apellidoUsuario}</td>
									<td>${topic.titulo}</td>
									<td>${topic.contenido}</td>
									<td>${topic.nombreCategoria}</td>
									<td><fmt:formatDate value="${topic.fecha_publicacion}"
									...
									<td><a
										href="${pageContext.request.contextPath}/Admin_S?action=EditTopic&id_topic=${topic.id_tema}"
										class="btn btn-sm btn-warning me-1"> <i
											class="bi bi-pencil-square"></i> Editar
									</a> <a
										href="${pageContext.request.contextPath}/Admin_S?action=DeleteTopic&id_topic=${topic.id_tema}"
			...
			<div class="mt-4">
				<a
					...
					href="${pageContext.request.contextPath}/Admin_S?action=ManageDeletedTopics"
					class="btn btn-secondary"> <i class="bi bi-arrow-left-circle"></i>
